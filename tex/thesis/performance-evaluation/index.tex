...
\begin{table}\label{tab:reference_parameters}
\caption{Reference Parameters in Simulation}
\begin{tabular}{l|ll}
                              & Parameter                          & Value                                \\ \hline
\multirow{10}{*}{Transceiver} & Truncation order                   & ${n_o} = 4$                          \\
                              ...
                              & Receive antenna gain               & ${G_r} = 2$ dBi                      \\ \hline
