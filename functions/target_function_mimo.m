function [negativePosynomial, positiveMonomial, positiveExponent] = target_function_mimo(k2, k4, tx, rx, resistance, subbandAmplitude, subband, powerAmplitude, infoAmplitude, powerPhase, infoPhase, powerSplitRatio)
% Function:
...
for iRx = 1: rx
    ...
    monomialOfTarget{iRx} = [monomialOfTargetP2 monomialOfTargetP4 monomialOfTargetI2 monomialOfTargetI4 monomialOfTargetP2I2];
    coef{iRx} = [coefP2 coefP4 coefI2 coefI4 coefP2I2];
end

monomialOfTarget = cell2mat(monomialOfTarget);
coef = cell2mat(coef);
