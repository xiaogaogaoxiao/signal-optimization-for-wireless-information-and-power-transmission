    ...
    for iTx0 = 1: tx
        for iTx1 = 1: tx
            for iRx = 1: rx
                ...
                monomialOfTargetP2(iTermP2) = abs(coefP2(iTermP2)) * ...
                        ...
                        for iTx2 = 1: tx
                            for iTx3 = 1: tx
                                for iRx = 1: rx
                                    ...
                                    monomialOfTargetP4(iTermP4) = abs(coefP4(iTermP4)) * ...
    ...
    for iTx0 = 1: tx
        for iTx1 = 1: tx
            for iRx = 1: rx
                ...
                monomialOfTargetI2(iTermI2) = abs(coefI2(iTermI2)) * ...
                ...
                for iTx2 = 1: tx
                    for iTx3 = 1: tx
                        for iRx = 1: rx
                            ...
                            monomialOfTargetI4(iTermI4) = abs(coefI4(iTermI4)) * ...
                ...
                for iTx2 = 1: tx
                    for iTx3 = 1: tx
                        for iRx = 1: rx
                            ...
                            monomialOfTargetP2I2(iTermP2I2) = abs(coefP2I2(iTermP2I2)) * ...
                                (powerAmplitude(iSubband0, iTx0) * subbandAmplitude(iSubband0, iTx0, iRx)) * ...
