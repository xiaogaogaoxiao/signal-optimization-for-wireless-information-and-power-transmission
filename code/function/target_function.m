                        ...
                        for iTx2 = 1: nTxs
                            for iTx3 = 1: nTxs
                                ...
                                monomialOfTargetP4(iTermP4) = ...
                                    (powerAmplitude(iSubband0, iTx0) * channelAmplitude(iSubband0, iTx0)) * ...
                                    (powerAmplitude(iSubband1, iTx1) * channelAmplitude(iSubband1, iTx1)) * ...
                                    (powerAmplitude(iSubband2, iTx2) * channelAmplitude(iSubband2, iTx2)) * ...
                                    (powerAmplitude(iSubband3, iTx3) * channelAmplitude(iSubband3, iTx3));
                            end
                        end
                    end
                end
                ...
                for iTx2 = 1: nTxs
                    for iTx3 = 1: nTxs
                        ...
                        monomialOfTargetP2I2(iTermP2I2) = ...
                            (powerAmplitude(iSubband0, iTx0) * channelAmplitude(iSubband0, iTx0)) * ...
                            (powerAmplitude(iSubband0, iTx1) * channelAmplitude(iSubband0, iTx1)) * ...
                            (infoAmplitude(iSubband1, iTx2) * channelAmplitude(iSubband1, iTx2)) * ...
                            (infoAmplitude(iSubband1, iTx3) * channelAmplitude(iSubband1, iTx3));
                    end
                end
            end
